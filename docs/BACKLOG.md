B1 Disable low attendance feature temporarily.
...
B7 Public announcements should only show "I'm in" and "I'm out" buttons (remove other management buttons).
B8 Add event identifier to the payment received message in the log chat.
...
B12 Unpin the previous announcement before pinning the new one.
